...
import Toggle2 from "./news/Box_team";
...
export default class Team extends Component {
    render() {
        return (
            <Flex  p={1} wrap>
                <Box w={1}>
                    <Toggle2 f={'علی نجیمی'} e={'۳ آذر ۱۳۹۷'} a='تاریخچه' b='به گزارش "ورزش سه" و به نقل از پایگاه خبری فوتسال ایران، در حالی که تغییر نسل عجیبی پس از جدایی افتخاری و حضور علی کفاشیان در کمیته فوتسال رخ داد، یکی از دوست داشتنی‌ترین اعضاء این کمیته با حالتی غریبانه خانه‌نشین شد تا کمتر خبری از او به میان آید.
